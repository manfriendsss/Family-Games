    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} onClick={onGoToImposter} className={cardClass}>
        ...
        <div className="flex-1">
          <h3 className="text-lg md:text-xl font-black text-gray-900 uppercase">Ai là người giả mạo?</h3>
      ...
      <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} onClick={onGoToCharades} className={cardClass}>
        ...
        <div className="flex-1">
          <h3 className="text-lg md:text-xl font-black text-gray-900 uppercase">Tôi là ai?</h3>
      ...
      <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} onClick={onGoToCaro} className={cardClass}>
        ...
        <div className="flex-1">
          <h3 className="text-lg md:text-xl font-black text-gray-900 uppercase">Cờ caro</h3>
      ...
      <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} onClick={onGoToDoanTu} className={cardClass}>
        ...
        <div className="flex-1">
          <h3 className="text-lg md:text-xl font-black text-gray-900 uppercase">Đoán từ</h3>
          <p className="text-sm font-medium text-gray-400">Taboo mini: mô tả và tránh từ cấm.</p>
        </div>
